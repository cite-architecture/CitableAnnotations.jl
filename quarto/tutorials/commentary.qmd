...
::: {.callout-tip}
The documentation for `CitableBase` includes [several dozen functions](https://neelsmith.quarto.pub/citablebase/reference/collections.html) that are available to use with citable collections, including `CitableCommentary`.  
:::
